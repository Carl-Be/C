...
*                                                                         *
* Warning - To much input. Only input %d char(s). Returning to Main Menu  *
*                                                                         *
...
void set_campus(struct student* student_records, char* line_buffer, char* placeholder, int current_student)
{
	...
	student_records[current_student].student_campus = malloc(strlen(placeholder));/*Allocates the correct memory to store the campus field*/
...
void set_id(struct student* student_records, char* line_buffer, char* placeholder, int current_student)
{
	...
	student_records[current_student].student_id = malloc(strlen(placeholder));/*Allocates the correct memory to store the id field*/
...
void set_name(struct student* student_records, char* line_buffer, char* placeholder, int current_student)
{
	...
	student_records[current_student].student_name = malloc(strlen(placeholder));/*Allocates the correct memory to store the name field*/
...
void set_program(struct student* student_records, char* line_buffer, char* placeholder, int current_student)
{
	...
	student_records[current_student].student_program = malloc(strlen(placeholder));/*Allocates the correct memory to store the program field*/
...
void student_campus_count(const struct student* student_records)
{
	...
	/*Since campuses are pre-defined we can use their first letters to determine which student is at what campus */
